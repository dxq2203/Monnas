...
from schemas.gameSession import GameSession, PlayerAction, StageResult, StageSnapshot, CumulativeState, PlayerActionCreate
import os
import json
import math
...
class GameEngine:
    ...
    def _calculate_stage_result(self, player_action: PlayerActionCreate, weather_data: dict, prev_state: CumulativeState) -> StageResult:
        """
    ...
    def play_stage(self, player_actions: PlayerActionCreate, weather_data: dict) -> GameSession:
        """
